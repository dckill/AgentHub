...
This project is indexed by GitNexus as **Happy-AgentRemote** (16342 symbols, 37988 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
