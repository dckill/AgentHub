...
async function migrate() {
    ...
    const candidates = [
        ...
        path.join(process.cwd(), "packages", "agenthub-server", "prisma", "migrations"),
...
switch (command) {
    ...
    case "serve":
        ...
        break;
    default:
        console.log(`agenthub-server - portable distribution

Usage:
  agenthub-server migrate    Apply database migrations
  agenthub-server serve      Start the server
...
Environment variables:
  ...
  PORT              Server port (default: 13017)
  AGENTHUB_MASTER_SECRET  Required: master secret for auth/encryption
  NODE_ENV          Use production for public deployments
  PUBLIC_URL        Public HTTPS base URL for generated file URLs
  AGENTHUB_ALLOWED_ORIGINS  Browser CORS/Socket.IO origins, comma-separated
`);
