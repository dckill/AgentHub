...
const LOCAL_IMAGE_REFERENCE_RED_PNG = 'iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAYAAABXAvmHAAAAZUlEQVR4nO3PMQ0AIADAMFRhAf8/XkAER0OyY3839lzn54YGNKABDWhAAxrQgAY0oAENaEADGtCABjSgAQ1oQAMa0IAGNKABDWhAAxrQgAY0oAENaEADGtCABjSgAQ1oQAMa8NoFnVIZPI8Wbn8AAAAASUVORK5CYII=';
const LOCAL_IMAGE_REFERENCE_TEAL_PNG = 'iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAYAAABXAvmHAAAAZElEQVR4nO3PMQ0AIADAMISgGQV4BREcDcmO/d2Ye52fGxrQgAY0oAENaEADGtCABjSgAQ1oQAMa0IAGNKABDWhAAxrQgAY0oAENaEADGtCABjSgAQ1oQAMa0IAGNKABDWjAaxdK8m4t3RJ+cwAAAABJRU5ErkJggg==';
...
export const debugMessages: Message[] = [
    ...
    {
        id: 'user-local-images',
        localId: null,
        createdAt: Date.now() - 198000,
        kind: 'user-text',
        text: 'Please compare these two screenshots before changing the layout.',
        images: [
            {
                data: LOCAL_IMAGE_REFERENCE_RED_PNG,
                mimeType: 'image/png',
            ...
            {
                data: LOCAL_IMAGE_REFERENCE_TEAL_PNG,
                mimeType: 'image/png',
                name: 'layout-after.png',
                width: 48,
                height: 48,
            },
        ],
...
Inline code now renders as \`agenthub render\` without a background highlight.
