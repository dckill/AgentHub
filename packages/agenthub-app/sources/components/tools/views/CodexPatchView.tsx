...
import { getDiffHeaderVisuals, getDiffStatColors } from '@/components/codeSurfaceVisuals';
                        ...
                        <View style={styles.patchContainer}>
                            <View style={styles.fileHeader}>
                                <View style={styles.fileHeaderMain}>
                                    <Octicons name="file-diff" size={16} color={getDiffHeaderVisuals(theme).iconColor} />
...
const styles = StyleSheet.create((theme) => ({
    patchContainer: {
        ...
        borderColor: getDiffHeaderVisuals(theme).borderColor,
        borderRadius: 8,
        borderWidth: 1,
        overflow: 'hidden',
    },
    fileHeader: {
        ...
        paddingVertical: 10,
        backgroundColor: getDiffHeaderVisuals(theme).backgroundColor,
        borderBottomWidth: 1,
        borderBottomColor: getDiffHeaderVisuals(theme).borderColor,
        gap: 4,
    },
    fileHeaderMain: {
        flexDirection: 'row',
    ...
    kindLabel: {
        fontSize: 11,
        color: getDiffHeaderVisuals(theme).iconColor,
    ...
    added: {
        fontSize: 12,
        fontFamily: 'monospace',
        color: getDiffStatColors(theme).addedText,
    },
    removed: {
        fontSize: 12,
        fontFamily: 'monospace',
        color: getDiffStatColors(theme).removedText,
    },
}));
