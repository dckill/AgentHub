...
import { canSubmitManualRestoreKey, getPostAuthLoginRoute } from '@/auth/loginFlow';
...
export default function Restore() {
    ...
    const canSubmit = canSubmitManualRestoreKey(restoreKey);
    ...
    const handleRestore = async () => {
        ...
        try {
            ...
            await auth.login(token, normalizedKey, { restoreExistingAccount: true });
