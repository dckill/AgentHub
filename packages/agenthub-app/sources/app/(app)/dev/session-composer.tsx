...
const SAMPLE_PATHS: PickerItem[] = [
    { key: 'agenthub', label: '~/projects/agenthub/agenthub' },
...
function SessionComposerDemo() {
    ...
    const [selectedPath, setSelectedPath] = React.useState('agenthub');
    ...
    const effortLevels = React.useMemo<EffortLevel[]>(
        () => getEffortLevelsForModel(selectedAgent, currentModelKey, t),
