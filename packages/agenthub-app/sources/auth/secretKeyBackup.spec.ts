...
describe('secretKeyBackup', () => {
    ...
    describe('normalizeSecretKey', () => {
        ...
        it('should not mistake a valid base64url key containing a hyphen for formatted base32', () => {
            const secretWithHyphen = 'Pk9gcYKTpLXG1-j5ChssPU5fcIGSo7TF1uf4CRorPE0';

            expect(decodeBase64(secretWithHyphen, 'base64url')).toHaveLength(32);
            expect(normalizeSecretKey(secretWithHyphen)).toBe(secretWithHyphen);
        });
