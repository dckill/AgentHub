 ...
 * 6. Current-provider and legacy-record compatibility
 */
...
describe('Zod Transform - WOLOG Content Normalization', () => {
    ...
    describe('Codex messages use native hyphenated schema (no transformation)', () => {
            ...
            const turnEnd = normalizeRawMessage('db-6', null, 1, {
                ...
                content: {
                    ...
                    data: {
                        ...
                        role: 'agent',
                        turn: 'turn-5',
                        ev: { t: 'turn-end', status: 'completed', finalTextId: 'answer-5' }
                    }
                }
            });
