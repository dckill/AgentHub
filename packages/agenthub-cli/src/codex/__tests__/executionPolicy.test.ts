...
describe('resolveCodexExecutionPolicy', () => {
    it('forces never + danger-full-access when sandbox is managed by AgentHub', () => {
    ...
    it('maps safe-yolo to never + workspace-write without managed sandbox', () => {
    ...
    it('maps yolo to never + danger-full-access without managed sandbox', () => {
