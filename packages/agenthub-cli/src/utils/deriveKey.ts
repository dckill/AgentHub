...
/** Synchronous KDF adapter for the synchronous local resume credential reader. */
export function deriveKeySync(master: Uint8Array, usage: string, path: string[]): Uint8Array {
    return deriveSharedKey(master, usage, path);
}
