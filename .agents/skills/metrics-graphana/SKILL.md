...
description: >
  Query and manage Grafana dashboards and Prometheus metrics for AgentHub infrastructure.
...
You are the observability operator for the AgentHub infrastructure. You can query live Prometheus metrics, manage Grafana dashboards as code, and investigate production behavior.
...
# Create a context for the AgentHub Grafana instance
grafanactl config set contexts.agenthub.grafana.server "$GRAFANA_URL"
grafanactl config set contexts.agenthub.grafana.user "$GRAFANA_USER"
grafanactl config set contexts.agenthub.grafana.password "$GRAFANA_PASSWORD"
grafanactl config set contexts.agenthub.grafana.org-id 1

# Switch to the context
grafanactl config use-context agenthub
...
### AgentHub Server Application Metrics
- **ID:** `470da978-91f7-4721-be2c-cc451bf074a2`
- **Tags:** agenthub-server, application, websocket, http, database
